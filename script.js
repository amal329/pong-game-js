...
var ballRadius=10, paddleWidth = 15, paddleHeight = 100;
...
function moveBall() {
    ...
    var paddle1Top = parseInt(paddle1.style.top), paddle1Bottom = parseInt(paddle1.style.top) + paddleHeight;
...
document.addEventListener("DOMContentLoaded", () => {
    menu.style.opacity=1;
    menuText.innerHTML="PONG : You(L) v/s (DUMB)Computer(R)";
});
